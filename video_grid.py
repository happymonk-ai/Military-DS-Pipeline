...
async def merge_videos(videos_in, video_out, grid_size=None, titles=None, title_position=(0.5, 0.5), max_frames: int = None):
    """
    Args:
...
if __name__ == '__main__':
    videos_to_merge = [
        '/home/nivetheni/DS_Gstrem_Pipeline/Nats_output/track/2/Nats_video2-0.mp4',
        '/home/nivetheni/DS_Gstrem_Pipeline/Nats_output/track/3/Nats_video3-3.mp4',
    ]
    titles = ['v1', 'v2']
    merge_videos(
        videos_to_merge,
